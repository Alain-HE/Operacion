...
df = pd.read_excel("Base_Telefonos_Cuentas_Conflicto_Ago23_DIRSA.xlsx")
df2 = pd.read_excel("Base_telefonos.xlsx")
...
dfSaldos_2 = pd.read_excel("Saldos_conflicto.xlsx")


dfSaldos = pd.concat([dfSaldos, dfSaldos_2], ignore_index=True)
...
#Se exporta
dfManual.to_excel("listado_manual_AGO_2023.xlsx",index=False)
